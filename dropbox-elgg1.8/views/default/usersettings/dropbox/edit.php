...
$access_key = elgg_get_plugin_user_setting('access_key', $user_id, 'dropbox');
$access_secret = elgg_get_plugin_user_setting('access_secret', $user_id, 'dropbox');
elgg_set_plugin_user_setting('access_key', '', $user_id, 'dropbox');
elgg_set_plugin_user_setting('access_secret', '', $user_id, 'dropbox');
...
if ($access_key && $access_secret) {
	try {
		...
		elgg_set_plugin_user_setting('token', $tokens['token'], $user_id, 'dropbox');
		elgg_set_plugin_user_setting('token_secret', $tokens['token_secret'], $user_id, 'dropbox');
	} catch (Dropbox_Exception $e) {
